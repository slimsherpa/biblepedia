      ...
      <header className="bg-gradient-to-r from-blue-800 to-indigo-900 text-white p-3 shadow-md">
        <div className="container mx-auto flex flex-col md:flex-row justify-between items-center">
          <h1 className="text-2xl font-bold mb-2 md:mb-0 flex items-center">
            <span className="font-serif tracking-wide">BiblePedia</span>
          ...
          <div className="flex items-center">
            ...
            <ErrorBoundary fallback={
              <select className="bg-white bg-opacity-10 border border-blue-400 text-white rounded-md px-3 py-1 text-sm">
